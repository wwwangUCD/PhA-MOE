...
def main(hidden=[100] * 5, seed=42):
    ...
    preTrainModel_dir = rf'D:\Research\EnvironmentalData\BenchmarkEvaluation_r3\papers_review\MDN_PACE_FT_9_2\seed_{seed}'
    # preTrainModel_dir = rf'D:\Research\EnvironmentalData\BenchmarkEvaluation_r3\papers_review\MDN_PACE_FT_9_4\seed_{seed}'
...
if __name__ == "__main__":
    ...
    selected_wl_range = [math.floor(num) for num in numbers]
    ...
    save_folder = r'D:\Research\EnvironmentalData\BenchmarkEvaluation_r3\papers_review\MDN_PACE_FT_9_2'
    # save_folder = r'D:\Research\EnvironmentalData\BenchmarkEvaluation_r3\papers_review\MDN_PACE_FT_9_4'

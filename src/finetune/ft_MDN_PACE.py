...
def main(hidden=[100] * 5, band_width=10, num_experts=6, k=4, gamma=100, seed=42):
    ...
    preTrainModel_dir = rf'D:\Research\EnvironmentalData\BenchmarkEvaluation_r3\Results_May4\PACE\robust_wholeband_log_wholeband\MDN\seed_{seed}'
    ...
    model = MDN(n_inputs=input_size, n_targets=output_size, hidden=hidden,lr=1e-4)
    ...
    for epoch in range(num_epochs):
        ...
        avg_val_loss = evaluate_model(model, val_loader, MDN_criterion, device)

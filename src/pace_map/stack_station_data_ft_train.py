...
import os
"""
in total there are 4+7+10=21 stations
0920+0925+1023
Rows containing NaN values: [ 6 16]
"""
...
# File names
files = ['ft_train_Rrs_Stations_0920.npy','ft_train_Rrs_Stations_0925.npy', 'ft_train_Rrs_Stations_1023.npy']
...
output_path = os.path.join(base_dir, 'ft_train_Rrs_all_stations.npy')
